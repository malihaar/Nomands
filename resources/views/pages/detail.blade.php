                    ...
                    <div class="col-lg-8 pl-lg-0">
                        <div class="card card-details">
                            ...
                            <div class="features row">
                                <div class="col-md-4">
                                    <img src="{{ url('frontend/images/ic_event.png') }}" alt="" class="featured-images">
                                ...
                                <div class="col-md-4 border-left">
                                    <img src="{{ url('frontend/images/ic_lang.png') }}" alt="" class="featured-images">
                                    <div class="description">
                                        <h3>Language</h3>
                                        <p>{{ $item->language }}</p>
                                    </div>
                                ...
                                <div class="col-md-4 border-left">
                                    <img src="{{ url('frontend/images/ic_food.png') }}" alt="" class="featured-images">
                                    <div class="description">
                                        <h3>Foods</h3>
                                        <p>{{ $item->foods }}</p>
                                    </div>
